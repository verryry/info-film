    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <form class="form-horizontal form-label-left" action="{{ route('film.store') }}" enctype="multipart/form-data"
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="judul" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                  data-validate-words="2" name="judul" placeholder="" required="required" type="text">
              </div>
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class='input-group date' id='myDatepicker4'>
                  <input id="tayang" type='text' class="form-control" readonly="readonly" name="tayang" />
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="bioskop" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                  data-validate-words="2" name="bioskop" placeholder="" required="required" type="text">
              </div>
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="harga" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                  data-validate-words="2" name="harga" placeholder="ex: Rp." required="required" type="text">
              </div>
            </div>
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="trailer" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                  data-validate-words="2" name="trailer" placeholder="https://www.youtube.com/embed/..." required="required" type="text">
              </div>
            </div>
            <div class="item form-group">
            ...
            <div class="item form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input id="image" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"
                  data-validate-words="2" name="image" required="required" type="file">
              </div>
            </div>
